...
@testitem "Compression" begin
    ...
    @testset "CSV" begin
        output_filename = tempname() * ".csv.gz"
        try
    ...
    @testset "TSV" begin
        output_filename = tempname() * ".tsv.gz"
        try
...
@testitem "show" begin
    ...
    open(joinpath(@__DIR__, "data.csv"), "r") do f
